...
class Tanh(Module): 
    ...
    def jacobian_check(self, eps=1e-5):
        ...
        for _ in xrange(100):
            ...
            similarity = relative_error(computedJacobian.reshape(self.inputDim * self.inputDim), np.diag(self.jacobian).reshape(self.inputDim * self.inputDim))
